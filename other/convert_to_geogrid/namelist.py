...
#         elif opt in ("-p","--param"):
#             param = arg.lower()
#         #...metafile disabled for now...
#         #elif opt in ("-m","--metafile"):
#         #    metafile = arg
#     #Get namelist opt/val
#     if (filename):
#         nmlopt = getnmlopt(filename)
#         if (nmlname):
#             if (param):
#                 try:
#                     for myval in nmlopt[nmlname][param]:
#                         #print param," = ",myval
#                         print myval
#                 except:
#                     pass
...
#             else:
#                 try:
#                     for mykey in nmlopt[nmlname].keys():
#                         for myval in nmlopt[nmlname][mykey]:
#                             print mykey," = ",myval
#                 except:
#                     print
#         else:
